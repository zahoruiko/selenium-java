package com.example.WebTableContent;
 ...
 */
public class TestStatisticDataInAWebTable extends BasicTestClass  {

    public TestStatisticDataInAWebTable() {
        pageUrl = "http://www.example.com/dataTable.php";
    }

    @Test
    public void testStatisticDataInAWebTable() throws ParseException {
