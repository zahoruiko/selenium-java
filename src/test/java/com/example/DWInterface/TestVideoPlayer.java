...
public class TestVideoPlayer extends BasicTestClass {
    ...
    public TestVideoPlayer() {
        pageUrl = "https://www.dw.com/en/exploring-old-and-new-ideas-on-the-future-of-food/a-53787877";
...
//        Thread.sleep(4000);
        ...
        WebElement videoContainer = driver.findElement(By.id("videoContainer-51250047"));
        ...
        pauseAndPlaybackButtonElement.click(); // Pause
        Thread.sleep(2000);
        ...
        pauseAndPlaybackButtonElement2.click(); // Play
